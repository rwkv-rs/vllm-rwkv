...
VLLM_BUILTIN_STRUCTURAL_TAG_MODELS = frozenset({"hermes", "hy_v4", "kimi_k3", "rwkv"})
...
def get_hermes_structural_tag(
    ...
    del builtin_tools, reasoning, parallel_tool_calls, token_suffix
...
def get_hy_v4_structural_tag(
    ...
    """
    del builtin_tools, parallel_tool_calls
