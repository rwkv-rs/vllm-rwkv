...
@register_fake("rwkv7_v3a_ops::layer_norm_f16")
...
@register_fake("rwkv7_v3a_ops::emb_ln0_bf16_to_f16")
...
@register_fake("rwkv7_v3a_ops::linear_f16")
@register_fake("rwkv7_v3a_ops::linear_f16_m1_splitk")
...
@register_fake("rwkv7_v3a_ops::linear_rkv_f16_m1_splitk")
...
@register_fake("rwkv7_v3a_ops::linear_f16_lt_cfg")
...
@register_fake("rwkv7_v3a_ops::linear_f16_fp32_lt")
...
@register_fake("rwkv7_v3a_ops::linear_f16_m1_splitk_fp32")
...
@register_fake("rwkv7_v3a_ops::linear_f16_m1_splitk_prepare_zero")
...
@register_fake("rwkv7_v3a_ops::linear_t_f16")
...
@register_fake("rwkv7_v3a_ops::linear_t_act_f16")
...
@register_fake("rwkv7_v3a_ops::linear_t_vres_f16")
...
@register_fake("rwkv7_v3a_ops::linear_wag_rank_in_f16")
...
@register_fake("rwkv7_v3a_ops::linear_wagv_rank_in_f16")
...
@register_fake("rwkv7_v3a_ops::linear_wag_rank_out_f16")
...
@register_fake("rwkv7_v3a_ops::linear_wagv_rank_out_f16")
...
@register_fake("rwkv7_v3a_ops::add_f16")
def _rwkv7_add_f16_fake(x: torch.Tensor, y: torch.Tensor) -> torch.Tensor:
    return _rwkv7_empty_like(x)


@register_fake("rwkv7_v3a_ops::add_layer_norm_f16")
...
@register_fake("rwkv7_v3a_ops::add_last_layer_norm_f16")
...
@register_fake("rwkv7_v3a_ops::add_layer_norm_cmix_mix_f16")
...
@register_fake("rwkv7_v3a_ops::add_layer_norm_cmix_mix_f16_slots")
...
@register_fake("rwkv7_v3a_ops::add_layer_norm_tmix_mix6_f16")
...
@register_fake("rwkv7_v3a_ops::add_layer_norm_tmix_mix6_f16_slots")
...
@register_fake("rwkv7_fast_ops_fp16::tmix_mix6")
@register_fake("rwkv7_fast_ops_fp16::tmix_mix6_3d")
...
@register_fake("rwkv7_fast_ops_fp16::tmix_mix6_slot")
...
@register_fake("rwkv7_fast_ops_fp16::tmix_mix6_varlen")
...
@register_fake("rwkv7_fast_ops_fp16::tmix_kk_a_gate")
@register_fake("rwkv7_fast_ops_fp16::tmix_kk_a_gate_2d")
...
@register_fake("rwkv7_fast_ops_fp16::tmix_lnx_rkvres_xg")
@register_fake("rwkv7_fast_ops_fp16::tmix_lnx_rkvres_xg_warp")
...
@register_fake("rwkv7_fast_ops_fp16::tmix_vres_gate")
...
@register_fake("rwkv7_fast_ops_fp16::cmix_sparse_down_relu_one")
...
@register_fake("rwkv7_fast_ops_fp16::cmix_sparse_down_relu_one_out")
...
@register_fake("rwkv7_fast_ops_fp16::cmix_sparse_down_relu_rows")
@register_fake("rwkv7_fast_ops_fp16::cmix_sparse_down_relu_rows_t512")
...
@register_fake("rwkv7_fast_ops_fp16::cmix_mix")
@register_fake("rwkv7_fast_ops_fp16::cmix_mix_3d")
...
@register_fake("rwkv7_fast_ops_fp16::cmix_mix_slot")
...
@register_fake("rwkv7_fast_ops_fp16::cmix_mix_varlen")
...
@register_fake("rwkv7_fast_ops_fp16::relu_square")
@register_fake("rwkv7_fast_ops_fp16::act_tanh")
@register_fake("rwkv7_fast_ops_fp16::act_sigmoid")
def _rwkv7_unary_fake(x: torch.Tensor) -> torch.Tensor:
    return _rwkv7_empty_like(x)


@register_fake("rwkv7_fast_ops_fp16::add_vec")
@register_fake("rwkv7_fast_ops_fp16::add_vec_2d")
def _rwkv7_add_vec_fake(C: int, x: torch.Tensor, vec: torch.Tensor) -> torch.Tensor:
    return _rwkv7_empty_like(x)


@register_fake("rwkv7_v3a_ops::advance_i32")
@register_fake("rwkv7_v3a_ops::advance_i32_slots")
@register_fake("rwkv7_v3a_ops::advance_i32_varlen")
